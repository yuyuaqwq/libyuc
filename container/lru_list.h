...
#define LruListInitByField(list, capacity, objName, entryFieldName, keyFieldName) LruListInit((list), (capacity), GetFieldOffset(objName, entryFieldName), sizeof(objName),  GetFieldOffset(objName, keyFieldName), GetFieldSize(objName, keyFieldName), NULL, NULL)
