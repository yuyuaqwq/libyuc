...
#ifndef LIBYUC_CONTAINER_BPLUS_TREE_CLASS_NAME
#define LIBYUC_CONTAINER_BPLUS_TREE_CLASS_NAME
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_Create
#define LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_Create(main_obj, obj_type) MemoryAlloc(sizeof(obj_type))
#endif
#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_CreateMultiple
#define LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_CreateMultiple(main_obj, obj_type, count) ((obj_type*)MemoryAlloc(sizeof(obj_type) * count))
#endif
#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_Release
#define LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_Release(main_obj, obj) MemoryFree(obj)
#endif


#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Id
#define LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Id struct BPlusEntry*
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Offset
#define LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Offset size_t
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Const_InvalidId
#define LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Const_InvalidId NULL
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Reference
#define LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Reference(main_obj, reference) (reference) 
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Dereference
#define LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Dereference(main_obj, reference)
#endif



#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Object
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Object int
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Key
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Key LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Object
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id struct BPlusElement*
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset size_t
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Const_InvalidId
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Const_InvalidId NULL
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Reference
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Reference(main_obj, reference) (reference) 
#endif

#ifndef LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Dereference
#define LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Dereference(main_obj, reference)
#endif
...
#define LIBYUC_CONTAINER_RB_TREE_CLASS_NAME BPlusEntry
...
#define LIBYUC_CONTAINER_VECTOR_CLASS_NAME BPlusIteratorStack
...
typedef struct {
    ...
    LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset left : sizeof(LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id) * 8 - 1;
...
forceinline LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id BPlusEntryRbAccessor_GetLeft(BPlusEntryRbTree* tree, BPlusEntryRbBsEntry* bs_entry) {
    return (LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id)(((BPlusEntryRbParentColor*)&(((BPlusEntryRbEntry*)bs_entry)->left))->left);
}
forceinline BPlusEntryRbColor BPlusEntryRbAccessor_GetColor(BPlusEntryRbTree* tree, BPlusEntryRbBsEntry* bs_entry) {
    return (BPlusEntryRbColor)(((BPlusEntryRbParentColor*)&(((BPlusEntryRbEntry*)bs_entry)->left))->color == -1 ? 1 : 0);
}
forceinline void BPlusEntryRbAccessor_SetLeft(BPlusEntryRbTree* tree, BPlusEntryRbBsEntry* bs_entry, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id new_id) {
    ((BPlusEntryRbParentColor*)&(((BPlusEntryRbEntry*)bs_entry)->left))->left = (LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset)new_id;
}
forceinline void BPlusEntryRbAccessor_SetColor(BPlusEntryRbTree* tree, BPlusEntryRbBsEntry* bs_entry, BPlusEntryRbColor new_color) {
    ((BPlusEntryRbParentColor*)&(((BPlusEntryRbEntry*)bs_entry)->left))->color = new_color;
}
...
LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Id BPlusEntryCreate(BPlusTree* tree, BPlusEntryType type) {
    ...
    if (type == kBPlusEntryIndex) {
        entry_id = LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_CreateBySize(tree, sizeof(BPlusEntry) - sizeof(BPlusLeafEntry) + sizeof(BPlusIndexEntry));
    }
    else {
        entry_id = LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_CreateBySize(tree, sizeof(BPlusEntry) - sizeof(BPlusIndexEntry) + sizeof(BPlusLeafEntry));
    }
    BPlusEntry* entry = LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Reference(tree, entry_id);
...
void BPlusEntryRelease(BPlusTree* tree, LIBYUC_CONTAINER_BPLUS_TREE_ENTRY_REFERENCER_Type_Id entry_id) {
    LIBYUC_CONTAINER_BPLUS_TREE_ALLOCATOR_Release(tree, entry_id);
}
...
*/
static LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id BuildRbTree(BPlusEntry* src_entry, BPlusEntryRbTreeIterator* element_iterator, BPlusEntry* dst_entry, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset left, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset right, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Id parent_id, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset max_level, LIBYUC_CONTAINER_BPLUS_TREE_ELEMENT_REFERENCER_Type_Offset level) {
