...
#define LIBYUC_CONTAINER_HASH_LIST_DEFINE(hash_list_type_name, key_type, accessor, allocater, hasher, comparer) \
    ...
    LIBYUC_CONTAINER_HASH_TABLE_DEFINE(hash_list_type_name##HashList, hash_list_type_name##HashListHashEntry, key_type, allocater, hash_list_type_name##HashListHashEntryAccessor, LIBYUC_BASIC_MOVER_DEFALUT, hasher, comparer) \
    \
    void hash_list_type_name##HashListInit(hash_list_type_name##HashList* list, size_t max_count) { \
