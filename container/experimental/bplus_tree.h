...
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DECLARATION_1(bp_tree_type_name, entry_id_type)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DECLARATION_2(bp_tree_type_name)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DECLARATION_3(bp_tree_type_name)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DEFINE_1(bp_tree_type_name, entry_id_type)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DEFINE_2(bp_tree_type_name)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DEFINE_3(bp_tree_type_name)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK_DEFINE_4(bp_tree_type_name)
#define LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK LIBYUC_CONTAINER_BPLUS_TREE_LEAF_LINK_MODE_NO_LINK
