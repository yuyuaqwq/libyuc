...
#define LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DECLARATION_1(ds_list_type_name, id_count_type) \
    /*
...
#define LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DECLARATION_2(ds_list_type_name, id_count_type, element_type, list_count, obj_arr_count) \
    typedef struct _##ds_list_type_name##DoublyStaticList{ \
        id_count_type list_first[list_count]; /* 最少应为1 */ \
        element_type obj_arr[obj_arr_count]; \
    } ds_list_type_name##DoublyStaticList; \
    \
    void ds_list_type_name##DoublyStaticListInit(ds_list_type_name##DoublyStaticList* list, id_count_type count); \
    id_count_type ds_list_type_name##DoublyStaticListPop(ds_list_type_name##DoublyStaticList* list, id_count_type list_order); \
    void ds_list_type_name##DoublyStaticListPush(ds_list_type_name##DoublyStaticList* list, id_count_type list_order, id_count_type index); \
    void ds_list_type_name##DoublyStaticListSwitch(ds_list_type_name##DoublyStaticList* list, id_count_type list_order, id_count_type index, id_count_type new_list_order); \

#define LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DECLARATION(ds_list_type_name, id_count_type, element_type, list_count, obj_arr_count) \
    LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DECLARATION_1(ds_list_type_name, id_count_type) \
    LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DECLARATION_2(ds_list_type_name, id_count_type, element_type, list_count, obj_arr_count) \


/*
* 访问器需要提供_GetNext、_SetNext、_GetPrev、_SetPrev方法
*/
#define LIBYUC_CONTAINER_DOUBLY_STATIC_LIST_DEFINE(ds_list_type_name, id_count_type, element_type, referencer, accessor, list_count) \
    void ds_list_type_name##DoublyStaticListInit(ds_list_type_name##DoublyStaticList* list, id_count_type count) { \
        list->list_first[0] = 0; \
        id_count_type i = 0; \
        for (; i < count - 1; i++) { \
    ...
    id_count_type ds_list_type_name##DoublyStaticListDelete(ds_list_type_name##DoublyStaticList* list, id_count_type list_order, id_count_type delete_index) { \
    ...
    void ds_list_type_name##DoublyStaticListInsert(ds_list_type_name##DoublyStaticList* list, id_count_type list_order, id_count_type prev_index, id_count_type insert_index) { \
    ...
    void ds_list_type_name##DoublyStaticListPush(ds_list_type_name##DoublyStaticList* list, id_count_type list_order, id_count_type push_index) { \
