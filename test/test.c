...
#define TEST_COMPARER_DEFALUT TEST_COMPARER_DEFALUT
    LIBYUC_CONTAINER_RB_TREE_DEFINE(Int, IntRbEntry*, int64_t, INT_RB_TREE_REFERENCER, INT_RB_TREE_ACCESSOR, LIBYUC_OBJECT_COMPARER_DEFALUT)//TEST_COMPARER_DEFALUT
