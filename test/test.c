...
LIBYUC_CONTAINER_HASH_TABLE_DEFINE(Int, LIBYUC_CONTAINER_HASH_TABLE_DEFAULT_MAX_DETECTION_COUNT, uint32_t, int64_t, int64_t, LIBYUC_OBJECT_ALLOCATOR_DEFALUT, INT_HASHTABLE_ACCESSOR, LIBYUC_OBJECT_MOVER_DEFALUT, INT_HASHTABLE_HASHER_KEY, LIBYUC_OBJECT_COMPARER_DEFALUT)
