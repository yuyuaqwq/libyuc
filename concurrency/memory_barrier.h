...
extern "C" {
  ...
  */
  static forceinline void BarrierLoadLoad() {
    _mm_lfence();
  }
  ...
  */
  static forceinline void BarrierStoreStore() {
    _mm_sfence();
  }
  ...
  */
  static forceinline void BarrierLoadStore() {
    _mm_mfence();
  }
  ...
  */
  static forceinline void BarrierStoreLoad() {
    // __faststorefence();
    _mm_mfence();
  }
#endif
